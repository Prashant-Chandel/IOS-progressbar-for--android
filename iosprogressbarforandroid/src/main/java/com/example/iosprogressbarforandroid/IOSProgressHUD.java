...
public class IOSProgressHUD {
    ...
    /**
     * Create a new HUD. specify the HUD style (if you use a custom view, you need {@code IOSProgressHUD.create(Context context)}).
     *
     * @param context Activity context that the HUD bound to
     * @param style   One of the IOSProgressHUD.Style values
     * @return An unique HUD instance
     */
     ...
     * @return Current HUD
     */
    public IOSProgressHUD setDimAmount(float dimAmount) {
     ...
     * @return Current HUD
     */
    public IOSProgressHUD setSize(int width, int height) {
     ...
     */
    @Deprecated
    public IOSProgressHUD setWindowColor(int color) {
        mWindowColor = color;
        return this;
    }
     ...
     * @return Current HUD
     */
    public IOSProgressHUD setBackgroundColor(int color) {
        mWindowColor = color;
        return this;
    }
     ...
     * @return Current HUD
     */
    public IOSProgressHUD setCornerRadius(float radius) {
     ...
     * @return Current HUD
     */
    public IOSProgressHUD setAnimationSpeed(int scale) {
        mAnimateSpeed = scale;
        return this;
    }
     ...
     * @return Current HUD
     */
    public IOSProgressHUD setLabel(String label) {
     ...
     * @return Current HUD
     */
    public IOSProgressHUD setLabel(String label, int color) {
     ...
     * @return Current HUD
     */
    public IOSProgressHUD setDetailsLabel(String detailsLabel) {
     ...
     * @return Current HUD
     */
    public IOSProgressHUD setDetailsLabel(String detailsLabel, int color) {
     ...
     * @return Current HUD
     */
    public IOSProgressHUD setMaxProgress(int maxProgress) {
     ...
     * @return Current HUD
     */
    public IOSProgressHUD setCancellable(boolean isCancellable) {
     ...
     * @return Current HUD
     */
    public IOSProgressHUD setCancellable(DialogInterface.OnCancelListener listener) {
     ...
     * @return Current HUD
     */
    public IOSProgressHUD setAutoDismiss(boolean isAutoDismiss) {
     ...
     * @return Current HUD
     */
    public IOSProgressHUD setGraceTime(int graceTimeMs) {
